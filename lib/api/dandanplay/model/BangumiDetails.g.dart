...
part of 'BangumiDetails.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BangumiDetails _$BangumiDetailsFromJson(Map<String, dynamic> json) =>
    BangumiDetails(
      json['bangumiId'] as String,
...
Map<String, dynamic> _$BangumiDetailsToJson(BangumiDetails instance) =>
    <String, dynamic>{
